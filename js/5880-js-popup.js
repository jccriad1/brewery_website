...
function popup1() {
    CreativaPopup.create('Feel free to DM me! sweatphilipp#0000 &#10084', 'Discord');
}
...
function popup13() {
    CreativaPopup.create('Feel free to DM me <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">sweatphilipp#0000</font> &#10084<br> <font style="color: #696969; font-size: smaller;"> or join my discord server <a href="https://dsc.gg/flyx-selling" style="color: #ADD8E6;">https://dsc.gg/flyx-selling</a> </font>', 'Discord', '', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
...
function allahm109kd() {
    navigator.clipboard.writeText("sweatphilipp#0000");
    setTimeout(function() {
